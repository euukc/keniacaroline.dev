    ...
    return (
        <section className="flex flex-col items-center min-h-screen py-2 w-full ">
            ...
            <span className="flex flex-row text-xl md:text-2xl items-center text-center px-2">
                Se você deseja entrar em contato comigo para solicitar orçamentos, me chame no WhatsApp ou mande um e-mail:
            </span>
            <div className="flex gap-6 mt-16">
                ...
                <Link className="border-2 rounded-lg p-2 bg-[#18181a]" href="https://api.whatsapp.com/send?phone=5511999999999" passHref>E-mail </Link>
            </div>
