        ...
        <div className="w-full min-h-screen">
            <div className="flex flex-col text-left gap-4 p-4 min-h-screen w-full pt-[130px] md:max-w-[1400px] mx-auto">
                ...
                <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-white">
                    <div className="rounded-lg border bg-[#1e1e1e] text-white shadow-md flex flex-col overflow-hidden w-[290px] md:w-[400px] min-h-[500px]">
                        <div>
                            <Image
                                src="/3d-platform.jpg"
                    ...
                    <div className="rounded-lg border bg-[#1e1e1e] text-white shadow-md flex flex-col overflow-hidden w-[290px] md:w-[400px] min-min-h-[500px]">
                        <Image
