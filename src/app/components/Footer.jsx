            ...
            <div className="rounded-xl border bg-accent/50 dark:backdrop-blur-2xl">
                <div className="items-center m-0 flex justify-center p-5">
                    <div className="grid-cols-5 items-center gap-3 flex">
                        <Link aria-label="Email" target="_blank" className="hover:bg-[#18181a] inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 w-10" href="">
